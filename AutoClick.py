...
def auto_click(modname, hwd_title, move_var, interval_seconds, loop_min):
    modname = modname
    ...
    for i in range(loop_times):
        ...
        if i == loop_times - 1:
            ...
            print("-----------------------%.2f秒后继续" % interval_seconds, "%s后结束-----------------------" % remaining_time)
...
def main():
    ...
    auto_click(modname, hwd_title, move_var, interval_seconds, loop_min)
